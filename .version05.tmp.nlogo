...
units-own [hp dmg speed atk-speed troop side fly? unit-range targeted-troop]
...
to units-spawn [t]
  ; variables: hp dmg speed atk-speed troop side fly? unit-range targeted-troop
...
to enemy-spawner
  every 3
   [
      enemies-spawn one-of [ "Archers" "Arrows" "Giant" "GoblinBarrel" "HogRider" "Minions" "MiniPekka" "SkeletonArmy" ]
  ]
end
